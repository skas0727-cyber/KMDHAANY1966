...
export const metadata = pageMeta(
  ...
  "논산 강경 교통사고 한의원 광명당한의원. 자동차보험 협약 의료기관으로 전 보험사 자동차보험이 적용되어 본인부담금 없이 침·약침, 추나요법, 한약, 한방물리요법을 받을 수 있습니다. 사고 당일 내원 가능, 월·수·금 야간진료."
);
...
const TREATMENTS = [
  ...
  ["room-spine.jpg", "추나요법", "사고 충격으로 틀어진 척추·관절의 균형 회복을 돕습니다."],
...
const STEPS = [
  ...
  ["치료 시작", "본인부담금 없이 침·약침, 추나, 한약, 한방물리요법을 받습니다."],
];
const FAQ = [
  ...
  return (
    <main>
      <section className="sub-hero photo">
        <img className="sub-hero-img" src="/img/backpain.jpg" alt="" style={{ objectPosition: "50% 45%" }} />
