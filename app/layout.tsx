...
export const metadata: Metadata = {
  ...
  ...pageMeta(
    ...
    "충남 논산시 강경읍 광명당한의원. 1966년 광명당한약방에서 시작해 3대째 이어온 한의원입니다. 침과 약침, 추나요법, 교통사고 후유증 치료(자동차보험 본인부담금 0원), 한방 다이어트, 피부 관리(슈링크, 토닝, 점 제거)를 하며, 평일은 저녁 8시까지 진료합니다."
  ),
...
const clinic = {
  ...
  openingHoursSpecification: [
    hours(WEEKDAYS, "08:30", "12:30"), hours(WEEKDAYS, "14:00", "20:00"),
